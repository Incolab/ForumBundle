...
class AdminController extends Controller
{
    public function indexAction(Request $request)
    {
        ...
        return $this->render(
            'IncolabForumBundle:Admin:index.html.twig',
            array('categories' => $categories, 'parentCatForm' => $form->createView())
        );
    ...
    public function parentCategoryAddAction(Request $request)
    {
        ...
        return $this->render(
            'IncolabForumBundle:Admin:parentCategoryAdd.html.twig',
            array('parentCatForm' => $form->createView())
        );
    }
    ...
    public function parentCategoryModifyAction($slug, Request $request)
    {
        ...
        return $this->render(
            'IncolabForumBundle:Admin:categoryModify.html.twig',
            array('catForm' => $form->createView())
        );
    }
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                return $this->redirectToRoute(
                    ...
                    array('slugParent' => $parentCat->getSlug())
                );
            }
            
            return $this->render(
                'IncolabForumBundle:Admin:childCategoryAdd.html.twig',
                array('category' => $parentCat, 'childCatForm' => $form->createView())
            );
        }
    ...
    public function roleAddAction(Request $request)
    {
        ...
        return $this->render(
            "IncolabForumBundle:Admin:forumRoleAdd.html.twig",
